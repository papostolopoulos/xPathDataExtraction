...
function minimizeMe(str, reg){
  ...
  for (var k = 0; k < punctuation.length; k++) {
    if (str.indexOf(punctuation[k]) < sliceEnd && str.indexOf(punctuation[k]) !== -1) sliceEnd = str.indexOf(punctuation[k]);
  }
